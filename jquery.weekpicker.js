;( function( $, window, document, undefined ) {
    ...
    var pluginName = "WeekPicker",
        defaults = {
            firstDay: 1,	// 주의 시작 : 1(월요일), 0(일요일)
            dateFormat: "yy-mm-dd",	// 기본값 변경
    ...
    $.extend( WeekPicker.prototype, {
        init: function() {
            ...
            $( "body" ).on( "mousemove", ".ui-weekpicker .ui-datepicker-calendar tr",
            	...
            	function() {
            		if ($settings.selectWeekBackground) {
            			$( this ).find( "td a" ).css( "background-color", $settings.selectWeekBackground );
            		} else {
